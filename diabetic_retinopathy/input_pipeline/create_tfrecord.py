...
def five2two(df):
    """Return a binary dataset instead of a 5-classes dataset"""
...
# Check the distribution of the balanced sets
...
# Five classes dataframe
# train_df = raw_train_df
# test_df = test_df

# Check the distribution after redefining the labels
train_df[['Retinopathy grade']].hist(figsize=(10, 5))
plt.title('Retinopathy grade of new train set')
plt.show()
test_df[['Retinopathy grade']].hist(figsize=(10, 5))
...
# Write new balanced data into TFRecords files
