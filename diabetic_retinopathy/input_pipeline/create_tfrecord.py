...
#
train_df.to_csv(
    '/Users/shengbo/Documents/Github/dl-lab-2020-team06/diabetic_retinopathy/IDRID_dataset/labels/new_train_2.csv',
    index=0, columns=['Image name', 'Retinopathy grade'])
test_df.to_csv(
    '/Users/shengbo/Documents/Github/dl-lab-2020-team06/diabetic_retinopathy/IDRID_dataset/labels/new_test_2.csv', index=0,
...
test_image_labels = row_csv2dict(
        '/Users/shengbo/Documents/Github/dl-lab-2020-team06/diabetic_retinopathy/IDRID_dataset/labels/new_test_2.csv')
